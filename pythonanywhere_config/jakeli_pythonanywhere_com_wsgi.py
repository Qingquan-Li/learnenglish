...
# web application at http://jakeli.pythonanywhere.com/
...
# # assuming your django settings file is at '/home/jakeli/mysite/mysite/settings.py'
# # and your manage.py is is at '/home/jakeli/mysite/manage.py'
# path = '/home/jakeli/mysite'
# if path not in sys.path:
#     sys.path.append(path)
